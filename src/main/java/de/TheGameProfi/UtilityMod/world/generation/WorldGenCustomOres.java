package de.TheGameProfi.UtilityMod.world.generation;
...
{
	private WorldGenerator steal_ore;
	private WorldGenerator rusty_ore;
	...
	public WorldGenCustomOres() 
	{
		...
		steal_ore = new WorldGenMinable(BlockInit.STEAL_ORE.getDefaultState(), 9, BlockMatcher.forBlock(Blocks.STONE));
		rusty_ore = new WorldGenMinable(BlockInit.RUSTY_ORE.getDefaultState(), 9, BlockMatcher.forBlock(Blocks.STONE));
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			runGenerator(steal_ore, world, random, chunkX, chunkZ, 90, 50, 52);
			runGenerator(rusty_ore, world, random, chunkX, chunkZ, 50, 0, 100);
